...
public:
  ...
  int   hamaxtargets;
  int   hamodel[MAX];
  int   haSlip[MAX];      // Neha Khetan, 19 October 2018, Adding motor slip
  ...
  ParamSim() {
    ...
    link("haSlip"      ,   haSlip      ,    MAX, "0", " Whether the hand slips or not. boolean: 0 - No ; 1 - Yes"); // Neha Khetan,19 oct 18
